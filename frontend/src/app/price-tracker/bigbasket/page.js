...
export default function BigBasketPage() {
    ...
    const fetchProducts = async () => {
        try {
            ...
            const response = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/bigbasket/products`, {
                params: {
                    page: currentPage,
                    pageSize: PAGE_SIZE,
                    sortOrder,
    ...
    return (
        <div className="container mx-auto p-6 bg-gray-100 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center mb-8 bg-white p-6 rounded-lg shadow-md">
                <h2 className="text-3xl font-bold text-gray-800 mb-4 sm:mb-0">BigBasket Price Tracker</h2>
            </div>
